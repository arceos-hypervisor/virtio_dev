...
/// from [`core::sync::atomic`](https://doc.rust-lang.org/core/sync/atomic/), except for
/// [`AtomicPtr<T>`](https://doc.rust-lang.org/core/sync/atomic/struct.AtomicPtr.html) and
...
impl_atomic_integer_ops!(core::sync::atomic::AtomicI8, i8);
impl_atomic_integer_ops!(core::sync::atomic::AtomicI16, i16);
impl_atomic_integer_ops!(core::sync::atomic::AtomicI32, i32);
#[cfg(any(
    target_arch = "x86_64",
    target_arch = "aarch64",
...
impl_atomic_integer_ops!(core::sync::atomic::AtomicI64, i64);

impl_atomic_integer_ops!(core::sync::atomic::AtomicU8, u8);
impl_atomic_integer_ops!(core::sync::atomic::AtomicU16, u16);
impl_atomic_integer_ops!(core::sync::atomic::AtomicU32, u32);
#[cfg(any(
    target_arch = "x86_64",
    target_arch = "aarch64",
    target_arch = "powerpc64",
...
impl_atomic_integer_ops!(core::sync::atomic::AtomicU64, u64);

impl_atomic_integer_ops!(core::sync::atomic::AtomicIsize, isize);
impl_atomic_integer_ops!(core::sync::atomic::AtomicUsize, usize);
